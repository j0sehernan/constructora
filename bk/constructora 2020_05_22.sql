...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2020 a las 02:29:24
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proyecto_venta_pago_i` (IN `p_proyecto_venta_id` INT, IN `p_fecha` VARCHAR(10), IN `p_comprobante_codigo` VARCHAR(100), IN `p_monto_moneda_venta` DECIMAL(20,2), IN `p_moneda_pago` VARCHAR(10), IN `p_moneda_pago_valor_conversion` DECIMAL(20,2), IN `p_monto_moneda_pago` DECIMAL(20,2), IN `p_igv` DECIMAL(20,2), IN `p_monto_total_moneda_pago` DECIMAL(20,2))  begin
 ...
 values(p_proyecto_venta_id,
  ...
  p_monto_moneda_pago, p_igv, p_monto_total_moneda_pago);
END$$
...
CREATE TABLE `comprobante_pago_tipo` (
...
CREATE TABLE `producto_stock_minimo` (
  `id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `unidad_medida_id` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `proyecto_inmueble` (
  `id` int(11) NOT NULL,
  `proyecto_id` int(11) NOT NULL,
  `codigo` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
  `nombre` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `proyecto_requerimiento` (
  `id` int(11) NOT NULL,
  `proyecto_id` int(11) NOT NULL,
  `codigo` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `proyecto_requerimiento_detalle` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `proyecto_trabajo_partida` (
  `id` int(11) NOT NULL,
  `codigo` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
  `nombre` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `proyecto_trabajo_partida_avance` (
  `id` int(11) NOT NULL,
  `proyecto_trabajo_partida_id` int(11) NOT NULL,
...
CREATE TABLE `proyecto_trabajo_partida_producto` (
  `id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `unidad_medida_id` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
  `cantidad` decimal(20,2) NOT NULL,
...
(5, 3, 1, 'USD', '101250.00', '20.00', '101230.00'),
(6, 5, 1, 'USD', '110000.00', '0.00', '110000.00');
...
CREATE TABLE `proyecto_venta_cronograma_pago` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `proyecto_venta_detalle` (
  `id` int(11) NOT NULL,
  `proyecto_venta_id` int(11) NOT NULL,
...
CREATE TABLE `proyecto_venta_pago` (
  `id` int(11) NOT NULL,
  `proyecto_venta_id` int(11) NOT NULL,
  `fecha` date NOT NULL,
...
INSERT INTO `proyecto_venta_pago` (`id`, `proyecto_venta_id`, `fecha`, `comprobante_codigo`, `monto_moneda_venta`, `moneda_pago`, `moneda_pago_valor_conversion`, `monto_moneda_pago`, `igv`, `monto_total_moneda_pago`) VALUES
(3, 5, '2020-05-01', '22222', '20.00', 'USD', '1.00', '20.00', '3.59', '23.60');
...
--
-- Indices de la tabla `comprobante_pago_tipo`
--
ALTER TABLE `comprobante_pago_tipo`
...
--
-- Indices de la tabla `email_tipo`
--
ALTER TABLE `email_tipo`
  ADD PRIMARY KEY (`codigo`);
...
--
-- Indices de la tabla `kardex_movimiento`
--
...
ALTER TABLE `orden_compra_detalle`
  ADD PRIMARY KEY (`id`),
  ADD KEY `orden_compra_detalle_fk` (`orden_compra_id`);

--
-- Indices de la tabla `pago_contratista`
--
ALTER TABLE `pago_contratista`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pago_proveedor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pago_proveedor_fk` (`orden_compra_id`);

--
-- Indices de la tabla `pago_proveedor_detalle`
--
ALTER TABLE `pago_proveedor_detalle`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pago_proveedor_detalle_fk` (`pago_proveedor_id`);
...
ALTER TABLE `persona_rol`
  ADD PRIMARY KEY (`id`),
  ADD KEY `persona_rol_fk` (`persona_id`),
  ADD KEY `persona_rol_fk_1` (`rol_id`);
...
--
-- Indices de la tabla `producto_stock_minimo`
--
ALTER TABLE `producto_stock_minimo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producto_stock_minimo_fk` (`producto_id`);
...
ALTER TABLE `producto_unidad_medida`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producto_unidad_medida_fk` (`producto_id`);
...
--
-- Indices de la tabla `proyecto_inmueble`
--
ALTER TABLE `proyecto_inmueble`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_inmueble_fk` (`proyecto_id`);

--
-- Indices de la tabla `proyecto_requerimiento`
--
ALTER TABLE `proyecto_requerimiento`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proyecto_requerimiento_detalle`
--
ALTER TABLE `proyecto_requerimiento_detalle`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_requerimiento_detalle_fk` (`proyecto_requerimiento_id`);

--
-- Indices de la tabla `proyecto_trabajo`
--
ALTER TABLE `proyecto_trabajo`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proyecto_trabajo_partida`
--
ALTER TABLE `proyecto_trabajo_partida`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proyecto_trabajo_partida_avance`
--
ALTER TABLE `proyecto_trabajo_partida_avance`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proyecto_trabajo_partida_producto`
--
ALTER TABLE `proyecto_trabajo_partida_producto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_trabajo_partida_producto_fk` (`producto_id`);

--
-- Indices de la tabla `proyecto_venta`
--
ALTER TABLE `proyecto_venta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_venta_fk` (`proyecto_id`),
  ADD KEY `proyecto_venta_fk_1` (`persona_cliente_id`);

--
-- Indices de la tabla `proyecto_venta_cronograma_pago`
--
ALTER TABLE `proyecto_venta_cronograma_pago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_venta_cronograma_pago_fk` (`proyecto_venta_id`);

--
-- Indices de la tabla `proyecto_venta_detalle`
--
ALTER TABLE `proyecto_venta_detalle`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_venta_detalle_fk` (`proyecto_venta_id`),
  ADD KEY `proyecto_venta_detalle_fk_1` (`proyecto_inmueble_id`);

--
-- Indices de la tabla `proyecto_venta_pago`
--
ALTER TABLE `proyecto_venta_pago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proyecto_venta_pago_fk` (`proyecto_venta_id`);
...
ALTER TABLE `rol_permiso`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rol_permiso_fk` (`rol_id`);

--
-- Indices de la tabla `telefono_tipo`
--
ALTER TABLE `telefono_tipo`
  ADD PRIMARY KEY (`codigo`);
...
--
-- AUTO_INCREMENT de la tabla `kardex_movimiento`
--
ALTER TABLE `kardex_movimiento`
...
--
-- AUTO_INCREMENT de la tabla `pago_contratista`
--
ALTER TABLE `pago_contratista`
...
--
-- AUTO_INCREMENT de la tabla `pago_proveedor_detalle`
--
ALTER TABLE `pago_proveedor_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `producto_stock_minimo`
--
ALTER TABLE `producto_stock_minimo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `producto_unidad_medida`
--
ALTER TABLE `producto_unidad_medida`
...
--
-- AUTO_INCREMENT de la tabla `proyecto_inmueble`
--
ALTER TABLE `proyecto_inmueble`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `proyecto_requerimiento`
--
ALTER TABLE `proyecto_requerimiento`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `proyecto_requerimiento_detalle`
--
ALTER TABLE `proyecto_requerimiento_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `proyecto_trabajo`
--
ALTER TABLE `proyecto_trabajo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `proyecto_trabajo_partida`
--
ALTER TABLE `proyecto_trabajo_partida`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT de la tabla `proyecto_trabajo_partida_avance`
--
ALTER TABLE `proyecto_trabajo_partida_avance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT de la tabla `proyecto_trabajo_partida_producto`
--
ALTER TABLE `proyecto_trabajo_partida_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `proyecto_venta`
--
ALTER TABLE `proyecto_venta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `proyecto_venta_cronograma_pago`
--
ALTER TABLE `proyecto_venta_cronograma_pago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `proyecto_venta_detalle`
--
ALTER TABLE `proyecto_venta_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `proyecto_venta_pago`
--
ALTER TABLE `proyecto_venta_pago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
