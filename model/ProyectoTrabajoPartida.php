...
class ProyectoTrabajoPartida
{
    function listByProyectoTrabajo($proyecto_trabajo_id)
    {
        ...
        $result = $db->query("select ptp.id, ptp.codigo, ptp.nombre, ptp.unidad_medida_id, um.nombre as unidad_medida, " .
            ...
            "(ifnull(ptp.cantidad_actual, 0) - ifnull(ptp.cantidad_presupuesto_actual, 0)) as cantidad_por_ejecutar, " .
            "(ifnull(ptp.precio_actual, 0) - ifnull(ptp.precio_real_acumulado, 0)) as precio_por_ejecutar, " .
